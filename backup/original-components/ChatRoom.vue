        ...
        <template #icon>
          <n-icon>
            <svg viewBox="0 0 24 24">
              <path
                fill="currentColor"
                d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,7C13.4,7 14.8,7.45 16,8.26V11C16,14.75 14.49,18.1 12,19.5C9.51,18.1 8,14.75 8,11V8.26C9.2,7.45 10.6,7 12,7M12,8.5C11,8.5 10,8.8 9.2,9.4V11C9.2,13.85 10.35,16.28 12,17.3C13.65,16.28 14.8,13.85 14.8,11V9.4C14,8.8 13,8.5 12,8.5Z"
              />
            </svg>
          </n-icon>
        </template>
